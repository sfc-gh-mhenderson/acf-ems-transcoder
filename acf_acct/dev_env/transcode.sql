CREATE OR REPLACE PROCEDURE PROCS_APP.TRANSCODE1("INPUTTABLENAME" VARCHAR, "PIDCOLUMN" VARCHAR, "LUIDCOLUMN" VARCHAR, "PARTNERLIST" VARCHAR, "RESULTSTABLENAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE PYTHON
