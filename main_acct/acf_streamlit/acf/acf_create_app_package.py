...
def create_app_package(app_code, app_pkg_name, source_table_list):
  ...
  create_consumer_events_master_v = """CREATE OR REPLACE SECURE VIEW """+app_pkg_name+""".EVENTS.EVENTS_MASTER_V COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"consumer","component":"app_pkg"}}'
  ...
  create_rules_dictionary_v = """CREATE OR REPLACE SECURE VIEW """+app_pkg_name+""".METADATA.RULES_DICTIONARY_V COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"app_pkg","component":"app_pkg"}}'
  ...
  sql_statements = [create_app_pkg
                    ...
                    ,create_sch_versions,create_sch_events,create_sch_metadata,create_sch_data
                    ,create_consumer_events_master_v,create_metadata_v,create_rules_dictionary_v
                    ,grant_usage_sch_events,grant_usage_sch_metadata,grant_usage_sch_data
                    ,grant_select_events_master_v,grant_select_metadata_v,grant_select_rules_dictionary_v]
