...
class manage_app_controls_page(BasePage):
    ...
    def print_page(self):
        ...
        col1, col2, col3, col4 = st.columns([1,2.5,0.3,0.54], gap="small")
        ...
        col1, col2, col3, col4 = st.columns([1,2.5,0.5,0.45], gap="small")
...
class app_package_page(BasePage):
    ...
    def print_page(self):
        ...
        with col1:
           st.subheader("Create Application Package")
        ...
        with col2:
           st.subheader("Manage Application Versions")
        ...
        with col1:
           st.subheader("Promote Application Package")
        ...
        with col2:
           st.subheader("Drop Application Package")
...
class app_package_version_page(BasePage):
    ...
    def print_page(self):
        ...
        col1, col2, col3, col4 = st.columns([1,2.5,0.5,0.525], gap="small")
...
class manage_consumers_page(BasePage):
    ...
    def print_page(self):
        ...
        with col2:
           st.subheader("Manage Consumer Controls")
...
pages = [app_control_home()
         ,manage_app_page(),manage_app_controls_page(),manage_app_rules_page(),app_package_page(),new_app_package_page(),app_package_version_page(),promote_to_prod_page(),app_package_drop_page()
