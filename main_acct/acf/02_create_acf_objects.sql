...
Objects(s):         DATABASE:             P_<APP_CODE>_ACF_DB
                    SCHEMA:               EVENTS
                    PROCEDURE:            UTIL.STREAM_TO_EVENT_MASTER
                    ...
                    TASKS:                EVENTS.<events_db>_EVENTS_TASKS (1-2)
                    SCHEMA:               METRICS
...
COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"events_master_table"}}';

--CREATE EVENTS_MASTER_STREAM
CREATE OR REPLACE STREAM EVENTS.EVENTS_MASTER_STREAM
  ON TABLE EVENTS.EVENTS_MASTER
  APPEND_ONLY = TRUE
  COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"events_master_stream"}}';

--CREATE CONTROL EVENTS TABLE
CREATE OR REPLACE TABLE EVENTS.CONTROL_EVENTS(
  msg VARIANT
)
COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"control_event_logs"}}';

--CREATE TABULAR VIEW OF CONSUMER_METRICS_MASTER TABLE
CREATE OR REPLACE VIEW METRICS.REQUEST_SUMMARY_MASTER_V COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"verification_metrics"}}'
AS
SELECT
...
CREATE OR REPLACE TABLE METADATA.METADATA_DICTIONARY(
  ...
  ,description VARCHAR
)COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"metadata_dictionary"}}';
...
CREATE OR REPLACE TABLE METADATA.RULES_DICTIONARY(
  ...
  ,description VARCHAR
)COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"rules_dictionary"}}';
...
CHANGE_TRACKING = TRUE
COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"consumer_metadata"}}';
...
RETURNS VARCHAR
LANGUAGE JAVASCRIPT
COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"stream_to_master"}}'
EXECUTE AS CALLER
AS
$$
  ...
  try {
    ...
    for(i = 0; i <= EVENTS_DBS.length; i++) {
      ...
      snowflake.execute({sqlText:`CREATE OR REPLACE STREAM EVENTS.${events_db}_EVENTS_STREAM
                                    ON TABLE ${events_db}.EVENTS.EVENTS
                                    APPEND_ONLY = TRUE
                                    SHOW_INITIAL_ROWS = TRUE
                                    COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"events_db_stream"}}';`});
      ...
      for(i = 1; i <= 2; i++) {
        snowflake.execute({sqlText:`CREATE OR REPLACE TASK EVENTS.${events_db}_EVENTS_TASK_${i}
                                      SCHEDULE = '1 minute'
                                      COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"events_db_task_${i}"}}'
                                      WHEN
...
RETURNS VARCHAR
LANGUAGE JAVASCRIPT
COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":""}'
EXECUTE AS CALLER
AS
$$
      ...
      for(i = 0; i < PKG_LIST.length; i++){
        ...
        for(i = 0; i < TABLE_LIST.length; i++){
          ...
          if(ACTION.toLocaleLowerCase() == 'grant') {
            ...
            snowflake.execute({sqlText:`CREATE OR REPLACE SECURE VIEW ${pkg}.DATA.${tbl} COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":""}'
...
CREATE STREAMLIT IF NOT EXISTS IDENTIFIER($ACF_STREAMLIT)
  ...
  COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"acf_streamlit_ui"}}';

--PUT ACF_STREAMLIT ITEMS ON STAGE
PUT 'file://&{DIR}/application_control_framework/main_acct/acf_streamlit/acf_streamlit.py' @ACF_STREAMLIT auto_compress=false overwrite=true;
PUT 'file://&{DIR}/application_control_framework/main_acct/acf_streamlit/acf/*' @ACF_STREAMLIT/acf auto_compress=false overwrite=true;
PUT 'file://&{DIR}/application_control_framework/main_acct/acf_streamlit/img/*' @ACF_STREAMLIT/img auto_compress=false overwrite=true;
...
COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"commands_table"}}';

--CREATE PROCEDURE TO EXECUTE COMMANDS
CREATE OR REPLACE PROCEDURE EXECUTE_CMD()
  RETURNS VARCHAR
  LANGUAGE JAVASCRIPT
  COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "attributes":{"role":"provider","component":"commands_procedure"}}'
  EXECUTE AS CALLER
  AS
  $$
...
CREATE OR REPLACE STREAM COMMANDS_STREAM
    ON TABLE COMMANDS
    APPEND_ONLY = TRUE
    COMMENT = '{"origin":"sf_sit","name":"acf","version":{"major":1, "minor":6},"attributes":{"role":"provider","component":"commands_stream"}}';
