...
CREATE OR REPLACE PROCEDURE ENRICH(APP_CODE VARCHAR, INPUT_TABLE_NAME VARCHAR, MATCH_KEY VARCHAR, RESULTS_TABLE_NAME VARCHAR)
  RETURNS VARCHAR
  LANGUAGE JAVASCRIPT
...
--replace default readme files with ones for the demo app
USE SCHEMA ARTIFACTS;
PUT 'file://&{DIR}/application_control_framework/main_acct/demo_app/templates/*' @ARTIFACTS/templates auto_compress=false overwrite=true;
